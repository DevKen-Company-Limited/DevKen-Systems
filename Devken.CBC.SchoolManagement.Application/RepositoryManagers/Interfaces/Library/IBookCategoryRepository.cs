...
{
    public interface IBookCategoryRepository : IRepositoryBase<BookCategory, Guid>
    {
        Task<IEnumerable<BookCategory>> GetAllAsync(bool trackChanges);
        Task<IEnumerable<BookCategory>> GetByTenantIdAsync(Guid tenantId, bool trackChanges);
