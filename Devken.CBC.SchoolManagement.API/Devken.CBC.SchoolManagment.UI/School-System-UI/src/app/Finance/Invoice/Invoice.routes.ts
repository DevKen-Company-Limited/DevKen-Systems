...
import { BulkInvoiceEnrollmentComponent } from "./bulk-invoice/bulk-invoice-enrollment/bulk-invoice-enrollment.component";
...
export default [
    ...
    { path: 'bulk-create',  component: BulkInvoiceEnrollmentComponent },
] as Routes;
