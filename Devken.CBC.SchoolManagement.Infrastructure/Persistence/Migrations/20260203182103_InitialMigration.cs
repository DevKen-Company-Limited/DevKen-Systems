        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Strand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SubStrand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    IsObservationBased = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningOutcomeId = table.Column<int>(type: "int", nullable: true),
                    FeedbackTemplate = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    RequiresRubric = table.Column<bool>(type: "bit", nullable: false),
                    Strand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    SubStrand = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    LearningOutcomeId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FormativeAssessments_LearningOutcomes_LearningOutcomeId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassMark = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 50.0m),
                    HasPracticalComponent = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    PracticalWeight = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 0.0m),
                    TheoryWeight = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 100.0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CurrentClassId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teachers_Classes_CurrentClassId1",
                        column: x => x.CurrentClassId1,
                        principalTable: "Classes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0.0m),
                    StatusInvoice = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ParentId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[Quantity] * [UnitPrice]"),
                    Discount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0.0m),
                    NetAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "([Quantity] * [UnitPrice]) - [Discount]"),
                    IsTaxable = table.Column<bool>(type: "bit", nullable: false),
                    TaxRate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    GlCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TeacherId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FormativeScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SummativeScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CompetencyScore = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetencyAssessmentScores_TenantId_CompetencyAssessmentId_StudentId",
                table: "CompetencyAssessmentScores",
                columns: new[] { "TenantId", "CompetencyAssessmentId", "StudentId" },
                unique: true,
                filter: "[CompetencyAssessmentId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CompetencyAssessmentScores_TenantId_StudentId",
                table: "CompetencyAssessmentScores",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormativeAssessments_LearningOutcomeId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_TenantId_AssessmentDate",
                table: "Grades",
                columns: new[] { "TenantId", "AssessmentDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teachers_CurrentClassId1",
                table: "Teachers",
                column: "CurrentClassId1");
