    ...
    public static class InfrastructureServiceRegistration
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                // These are the policies referenced by FeeStructuresController,
                // FeeItemsController, and other broad finance endpoints.
            ...
            services.AddScoped<IFeeStructureRepository, FeeStructureRepository>(); // ← NEW
